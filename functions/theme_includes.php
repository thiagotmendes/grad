...
<<<<<<< HEAD
=======
	wp_enqueue_style( 'Estilo', get_template_directory_uri().'/css/estilo.css', array(),'1.0.0', 'screen' );
>>>>>>> cc70505338358502181738e458a67ae37cff1e42
	...
	//wp_enqueue_style( 'effects', get_template_directory_uri().'/css/effects.css', array(),'1.0.0', 'screen' );
	...
	/* JS */
<<<<<<< HEAD
	wp_enqueue_script( 'jQuery', get_template_directory_uri() . '/js/jquery-3.0.0.min.js', array(), '3.0.0', false );
	...
	wp_enqueue_script( 'maskedinput', get_template_directory_uri() . '/js/jquery.maskedinput.js', array(),'1.5.9', true );
=======
	wp_enqueue_script( 'jQuery', get_template_directory_uri() . '/js/jquery-1.12.4.js', array(), '3.0.0', false );
	wp_enqueue_script( 'Bootstrap', get_template_directory_uri() . '/js/bootstrap.js', array(), '3.3.5', true );
	wp_enqueue_script( 'slick', get_template_directory_uri() . '/js/slick.js', array(),'1.5.9', true );
