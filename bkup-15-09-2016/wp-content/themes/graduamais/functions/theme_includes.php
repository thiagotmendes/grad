...
if(!is_admin()){
	...
	wp_enqueue_style( 'yamm', get_template_directory_uri().'/css/yamm.css', array(),'1.0.0', 'screen' );
	...
	wp_enqueue_style( 'animate', get_template_directory_uri().'/css/animate.css', array(),'1.5.9', 'screen' );
