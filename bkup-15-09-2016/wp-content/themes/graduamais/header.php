            ...
            <div class="col-md-7 form-head">
              ...
              <span>
                <a class="btn btn-call-top" href="#" role="button" data-toggle="modal" data-target="#ligacao-cliente">
                  <i class="fa fa-phone" aria-hidden="true"></i> Ligamos para você. Clique Aqui!</a>
              </span>
            </div>
          </div>
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">Você tem interesse em alguma Pós-Graduação ou 2ª Graduação?</h4>
      </div>
      <div class="modal-body">
        <p><?php echo do_shortcode('[contact-form-7 id="618" title="form-modal"]') ?></p>
      </div>
