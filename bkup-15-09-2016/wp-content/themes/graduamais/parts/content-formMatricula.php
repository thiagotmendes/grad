       ...
       <div class="row box-cinza-form">
          ...
          <div class="col-md-8">
            <div class="form-pagamento">
              ...
              $val5 = get_post_field('valor_final_5', $idCurso);
              if ($val5):
                echo '<label class="radio-inline">';
                  $valini5 = get_post_field('valor_inicial_5', $idCurso);
                  if ($valini5) {
                    echo "<strike> R$" .get_post_field('valor_inicial_5', $idCurso) ."</strike> <br>";
                  }
                  echo '<input type="radio" name="parcela" id="inlineCheckbox1" value="R$ '.$val5.'">';
                  echo get_post_field('valor_final_5', $idCurso);
                echo '</label>';
              endif;
              ?>
            </div>
