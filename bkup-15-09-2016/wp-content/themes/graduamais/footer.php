    ...
    <div class="row">
      ...
      <div class="col-md-2 menu-rodape">
        <div class="sociais-footer">
          ...
          <a href="https://plus.google.com/109714730035419030606/posts" target="_blank"> <img src="<?php echo get_template_directory_uri() ?>/images/s4.png" alt="" class="sociais-col-direita"/></a><br>
